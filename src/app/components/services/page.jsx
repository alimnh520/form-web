        ...
        <div className="bg-gray-100 h-screen w-full flex flex-col items-center justify-center px-20 bg-fixed bg-center sm:px-5 sm:pb-10 sm:h-auto">
            <div className="w-full h-80 flex flex-col space-y-5 items-center justify-center sm:h-auto sm:justify-start sm:mt-5">
                ...
                <div className="w-11/12 h-auto grid grid-rows-2 grid-cols-4 gap-8 sm:gap-4 sm:grid-cols-2 sm:grid-rows-3 sm:h-auto sm:gap-y-5">
                    ...
                    <Link href="/components/services/land-tax2" className="shadow-[0_0_10px_rgba(0,0,0,0.5)] cursor-pointer bg-white rounded-md flex flex-col items-center justify-center relative space-y-5 sm:h-52 h-56 sm:space-y-3 sm:justify-end sm:pb-4">
                    ...
                    <Link href="" className="shadow-[0_0_10px_rgba(0,0,0,0.5)] cursor-pointer bg-white rounded-md flex flex-col items-center justify-center relative space-y-5 sm:h-52 h-56 sm:space-y-3 sm:justify-end">
                        ...
                        <h1 className='text-2xl sm:text-lg sm:text-center font-semibold sm:px-4'>জন্মনিবন্ধন সেবা</h1>
                    ...
                    <Link href="" className="shadow-[0_0_10px_rgba(0,0,0,0.5)] cursor-pointer bg-white rounded-md flex flex-col items-center justify-center relative space-y-5 sm:h-52 h-56 sm:space-y-3 sm:justify-end">
                        ...
                        <h1 className='text-2xl sm:text-lg sm:text-center font-semibold sm:px-4'>NID  সংক্রান্ত সেবা</h1>
