...
const Footer = () => {
    ...
    return (
        <div className={`w-full h-96 bg-green-100 text-black mt-7 pt-16 px-8 flex items-center justify-between gap-x-2 ${path === '/' ? 'sm:h-auto sm:gap-x-0 sm:gap-y-5 sm:flex-col sm:px-0 sm:pt-5' : 'dakhila'}`}>

            <div className="h-full w-auto flex flex-col items-center justify-start gap-y-4">
                <p className='text-2xl text-green-800 self-start ml-4 sm:ml-5'>গুরুত্বপূর্ণ লিঙ্ক</p>
            ...
            <div className="w-auto h-full flex items-center justify-center gap-x-8 sm:px-5 sm:flex-col sm:gap-y-5">
                <div className="w-auto h-full flex flex-col items-center justify-start gap-y-5">
                    <p className='text-2xl text-green-800'>পরিকল্পনা ও বাস্তবায়নে</p>
                    <img src="/logos/my-logo/Logo-01.png" alt="" className='h-32 -mt-9' />
                    <p className='text-2xl font-semibold text-center -mt-10 text-green-800'>রাজিম ল্যান্ড সার্ভিস <br />  এন্ড কনসালটেন্ট <span className='text-red-600'>(অনলাইন)</span></p>
                </div>
                <div className="w-auto h-full flex flex-col items-center justify-start gap-y-5">
                    <p className='text-2xl text-green-800'>অ্যাপ ডাউনলোড করুন</p>
