...
const Footer = () => {
    ...
    return (
        <div className={`w-full h-96 bg-green-100 text-black mt-7 pt-16 px-10 flex items-center justify-between gap-x-8 ${path === '/' ? 'sm:h-auto sm:gap-x-0 sm:gap-y-5 sm:flex-col sm:px-0 sm:pt-5' : 'dakhila'}`}>
