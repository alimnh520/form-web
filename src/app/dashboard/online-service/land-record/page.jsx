                    ...
                    user ? user.map((elem) => {
                        return (
                            <div className="flex items-center justify-center gap-x-5 sm:gap-x-3" key={elem._id}>
                                ...
                                <Link href={`/dashboard/online-service/land-record/${elem._id}`} className="px-5 py-1 bg-blue-600 text-lg rounded-lg font-semibold text-white sm:text-sm sm:px-2 sm:py-2">
                                    See details
                                </Link>
