                    ...
                    <div className='w-full flex flex-col items-center justify-center p-4 bg-lime-50' key={elem._id}>
                        ...
                        <div className={`w-[765px] h-[1250px] mt-10 flex flex-col items-start text-[13.5px] p-4 border-[1.5px] border-dotted border-black text-zinc-800 text- rounded-md bg-white gap-y-[5px]`}>
                            ...
                            <div className="w-full flex items-center justify-center">
                                <p className="text-center">ভূমি উন্নয়ন কর পরিশোধ রসিদ <br /> (অনুচ্ছেদ ৩৯২ দ্রষ্টব্য)</p>
                            </div>

                            <div className="w-full flex justify-start items-center mt-2">
                                <p className='w-[43%]'>সিটি কর্পোরেশন/পৌর/ ইউনিয়ন ভূমি অফিসের নাম:</p>
                                <p className='w-[57%] border-b-[1.5px] border-dotted border-b-black'>{elem.unionNum}</p>
                            </div>

                            <div className="w-full flex items-start justify-start">
                                <div className="w-[45%] flex items-center justify-start">
                                    <p className='w-[50%]'>মৌজার নাম ও জে. এল, নং:</p>
                                    <p className=" w-[50%] border-b-[1.5px] border-dotted border-b-black">{elem.moujarNam}</p>
                                </div>
                                <div className="w-[55%] flex items-center justify-start">
                                    <div className="flex items-center justify-start space-x-0 w-7/12">
                                        ...
                                        <p className='border-b-[1.5px] border-dotted border-b-black w-7/12'>{elem.thana}</p>
                                    </div>
                                    <div className="w-5/12 flex items-center justify-start space-x-2">
                                        <p>জেলা:</p>
                                        <p className='border-b-[1.5px] border-dotted border-b-black w-full'>{elem.district}</p>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    elem.ownerData.filter((elem, index) => index % 2 === 0).map((elem) => {
                                                        return (
                                                            <tr className='w-full flex items-center justify-center border-dotted border-b-[1.5px] border-b-black' key={elem.ownerCromik}>
                                                                ...
                                                                <td className='w-[55%] px-5'>{elem.ownerName}</td>
                                                                <td className='w-[30%] border-l-[1.5px] border-dotted border-l-black text-center'>{elem.ownerProperty}</td>
                                                            </tr>
                                                        )
                                                    })
                                                }
                            ...
                            <div className="w-full flex flex-col items-center justify-center mt-2 ">
                                ...
                                <div className="w-full flex items-center justify-between space-x-3 mt-3 text-[11px]">
                                                    ...
                                                    elem.landData.filter((elem, index) => index % 2 === 0).map((elem) => {
                                                        return (
                                                            <tr className='w-full flex items-center justify-center border-dotted border-b-[1.5px] border-b-black' key={elem.landCromik}>
                                                                ...
                                                                <td className='w-[20%] border-r-[1.5px] border-dotted border-r-black text-center'>{elem.dagNum}</td>
                                                                <td className='w-[25%] border-r-[1.5px] border-dotted border-r-black text-center'>{elem.landClass}</td>
                                                                <td className='w-[40%] text-center'>{elem.landSize}</td>
                                                            </tr>
                                                        )
                                                    })
                                                }
                                    ...
                                    <div className={`w-1/2 ${elem.landData.length < 2 ? 'hidden' : 'flex'} items-center justify-center`}>
                                        <table className="w-full border-dotted border-t-[1.5px] border-t-black border-l-[1.5px] border-l-black border-r-[1.5px] border-r-black flex flex-col items-center justify-center">
                                            <thead className='w-full border-b-[1.5px] border-dotted border-b-black'>
                                                <tr className='w-full flex items-center justify-center'>
                                                    <th className='w-[15%] border-r-[1.5px] border-dotted border-r-black'>ক্রম </th>
                            ...
                            <div className="w-full flex items-center justify-between border-[1.5px] border-dotted border-black mt-2">
                                <p className='text-center mt-0.5 w-1/2 border-r-[1.5px] border-dotted border-r-black'>সর্বমোট জমি (শতাংশ)</p>
                                ...
                                <table className="w-full flex flex-col items-center justify-center">
                                    <thead className='w-full border-t-[1.5px] border-t-zinc-200 border-b-[1.5px] border-b-zinc-200'>
                                        <tr className='w-full flex items-center justify-center'>
                                            ...
                                            <th className='w-[10%] font-medium border-r-[1.5px] border-r-zinc-200 py-2'>মোট <br /> বকেয়া </th>
                                            <th className='w-[6%] font-medium mb-5'> মন্তব্য </th>
                                        </tr>
                                    </thead>
                                    <tbody className='w-full'>
                                        <tr className='w-full bg-slate-100 flex items-center justify-center'>
                                            <td className='w-[20%] text-center border-r-[1.5px] border-r-zinc-200 p-2'>{elem.loanPlus}</td>
                                            <td className='w-[19%] text-center border-r-[1.5px] border-r-zinc-200 p-2'>{elem.loan}</td>
                                            <td className='w-[20%] text-center border-r-[1.5px] border-r-zinc-200 p-2'>{elem.loanFine}</td>
                            ...
                            <div className="w-full flex items-start mt-1.5 justify-between text-[13px]">
                                ...
                                <div className="mt-3">
                                    <QRCodeCanvas value={url} size={80} className='' />
                                </div>
